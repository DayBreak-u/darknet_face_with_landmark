...
if os.name == "nt":
    ...
    lib = CDLL("/mnt/data1/yanghuiyu/project/object_detect/darknetwithlandmark/libdarknet.so", RTLD_GLOBAL)
        ...
        for i in range(meta.classes):
            ...
            if dets[j].prob[i] > 0:
                ...
                res.append((nameTag, dets[j].prob[i], (b.x, b.y, b.w, b.h),
                            (b.lx1,b.ly1,b.lx2,b.ly2,b.lx3,b.ly3,b.lx4,b.ly4,b.lx5,b.ly5)))
